    ...
    public class Bank
    {
        ...
        public void AccountCreation(String name,double amount){
            if(!this.Max_numReached()){
                ...
                if(e!=-1){
                    this.result=String.format("Error: Client %s aldredy exists",name);
                }
                else if(amount<=0){
        ...
        public void Statement(int id,String name){
            if(id!=-1){
                ...
                for(int i=0;i<c.getTransactionCount();i++){
        ...
        public void ClientTransaction(String s,int idFrom,int idTo,double amount,String account1,String account2){
            ...
            {
                if(idTo==-1){
                    this.result=String.format("Error: To-Client %s does not exist.",account2);
                }
                else if(amount<=0){
                ...
                if(idFrom==-1){
                    this.result=String.format("Error: From-Client %s does not exist.",account1);
                }
                else if(amount<=0){
                   this.result="Error: Non-Positive Amount";
                }
